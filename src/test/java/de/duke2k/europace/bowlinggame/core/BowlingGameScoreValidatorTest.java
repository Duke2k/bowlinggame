...
public class BowlingGameScoreValidatorTest {
	...
	public void validate_KeineWerte() {
		try {
			...
			assertEquals("Es wurden nicht genau 20 Werte (bei 10 Frames) geliefert!", e.getMessage());
		}
	}
	...
	public void validate_ZuGrosserWertEinWurf() {
		try {
			...
			assertEquals("Ungültige Anzahl umgeworfener Pins bei Frame 5!", e.getMessage());
		}
	}
	...
	public void validate_ZuKleinerWert() {
		try {
			...
			assertEquals("Ungültige Anzahl umgeworfener Pins bei Frame 7!", e.getMessage());
		}
	}
